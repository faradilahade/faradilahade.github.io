...
export default function NotFound() {
  ...
  return (
    <section className="page-enter max-w-site mx-auto px-gutter py-section text-center">
      ...
      <Link to="/" className="mt-8 inline-flex items-center gap-2 border border-ink/20 px-5 py-3 btn-text rounded-full hover:border-steel hover:text-steel transition-colors">
