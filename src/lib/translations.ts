...
const en: Dict = {
  ...
  'showcase.title': 'My work',
  'showcase.sub': 'Selected data, finance and risk work. Open any piece to scroll through the full case study and the tools behind it.',
  'showcase.tab.all': 'Work',
  'showcase.tab.featured': 'Featured',
  'showcase.recent': 'Most recent works',
  'showcase.selected': 'Selected works',
  'showcase.contact': 'Contact',
  'showcase.stat.projects': 'Projects',
  'showcase.stat.tools': 'Tools',
  'showcase.stat.clients': 'Clients',
  'showcase.stat.fields': 'Fields',
  'showcase.web': 'On the web',
  'showcase.info': 'Info',
  'showcase.available': 'Available for remote work worldwide',
  'showcase.viewAll': 'Browse the full catalogue',
  'showcase.empty': 'Work will appear here once it is published.',
  'showcase.role': 'Actuarial Data Scientist',
  'showcase.org': 'Founder, Anak Aktuaria',
...
const id: Dict = {
  ...
  'showcase.title': 'Karya saya',
  'showcase.sub': 'Karya pilihan di bidang data, keuangan, dan risiko. Buka salah satu untuk menelusuri studi kasus lengkap beserta tools di baliknya.',
  'showcase.tab.all': 'Karya',
  'showcase.tab.featured': 'Unggulan',
  'showcase.recent': 'Karya terbaru',
  'showcase.selected': 'Karya pilihan',
  'showcase.contact': 'Kontak',
  'showcase.stat.projects': 'Proyek',
  'showcase.stat.tools': 'Tools',
  'showcase.stat.clients': 'Klien',
  'showcase.stat.fields': 'Bidang',
  'showcase.web': 'Di internet',
  'showcase.info': 'Info',
  'showcase.available': 'Tersedia untuk kerja remote di seluruh dunia',
  'showcase.viewAll': 'Jelajahi katalog lengkap',
  'showcase.empty': 'Karya akan tampil di sini setelah dipublikasikan.',
  'showcase.role': 'Actuarial Data Scientist',
  'showcase.org': 'Pendiri, Anak Aktuaria',
...
const ja: Dict = {
  ...
  'showcase.title': '私の実績',
  'showcase.sub': 'データ・金融・リスク分野の主な実績。作品を開くと、事例の全文と使用ツールをスクロールして確認できます。',
  'showcase.tab.all': '実績',
  'showcase.tab.featured': '注目',
  'showcase.recent': '最近の実績',
  'showcase.selected': '厳選した実績',
  'showcase.contact': '連絡する',
  'showcase.stat.projects': 'プロジェクト',
  'showcase.stat.tools': 'ツール',
  'showcase.stat.clients': 'クライアント',
  'showcase.stat.fields': '分野',
  'showcase.web': 'ウェブ上で',
  'showcase.info': '紹介',
  'showcase.available': '世界中のリモート案件に対応',
  'showcase.viewAll': 'カタログ全体を見る',
  'showcase.empty': '公開されると、ここに実績が表示されます。',
  'showcase.role': 'アクチュアリー・データサイエンティスト',
  'showcase.org': 'Anak Aktuaria 創設者',
...
const zh: Dict = {
  ...
  'showcase.title': '我的作品',
  'showcase.sub': '数据、金融与风险领域的精选作品。打开任意作品即可滚动浏览完整案例及所用工具。',
  'showcase.tab.all': '作品',
  'showcase.tab.featured': '精选',
  'showcase.recent': '最新作品',
  'showcase.selected': '精选作品',
  'showcase.contact': '联系',
  'showcase.stat.projects': '项目',
  'showcase.stat.tools': '工具',
  'showcase.stat.clients': '客户',
  'showcase.stat.fields': '领域',
  'showcase.web': '网络主页',
  'showcase.info': '简介',
  'showcase.available': '承接全球远程工作',
  'showcase.viewAll': '浏览完整目录',
  'showcase.empty': '作品发布后将显示在这里。',
  'showcase.role': '精算数据科学家',
  'showcase.org': 'Anak Aktuaria 创始人',
