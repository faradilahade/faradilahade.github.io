...
export default function Wordmark() {
  const { t } = useLang()
  return (
    <section className="relative bg-steel text-paper overflow-hidden h-[clamp(140px,19vw,290px)]" aria-label={site.name}>
      <div
      ...
      <a
        href={mailto()}
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex items-stretch bg-ink text-paper text-[11px] font-semibold uppercase tracking-[.16em] shadow-lift hover:bg-night transition-colors"
      >
